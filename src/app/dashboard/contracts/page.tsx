    ...
    return (
        <div className="space-y-8">
            <header className="mb-10">
                ...
                <p className="text-slate-500 font-bold text-xs uppercase tracking-widest mt-2 ml-1 italic">Vérifiez vos garanties et engagements</p>
            </header>
                ...
                <div className="p-10 bg-white/5 border border-white/10 rounded-[2.5rem] relative overflow-hidden">
                    ...
                    <div className="space-y-6 relative z-10">
                        {projects.map(project => (
                            <div key={project.id} className="p-6 bg-slate-900 border border-white/5 rounded-2xl flex items-center justify-between group hover:border-blue-500/20 transition-all">
